...
import { CreateExamProviderViewModel } from '../../../../core/DTO/create-exam-provider-view-model';
...
export class SignUpComponent implements OnInit {
  ...
  createExamProviderViewModel: CreateExamProviderViewModel = {
    userId: 0,
    planId: 0,
  ...
  createExamProvider(userId: number, encToken: string): void {
    ...
    this.examProviderApis.createExamProvider(this.createExamProviderViewModel).subscribe(
      (response: ApiResponse<CreateExamProviderViewModel>) => {
